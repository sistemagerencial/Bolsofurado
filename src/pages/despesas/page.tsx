    ...
    <MainLayout>
      <div className="p-4 sm:p-6 lg:p-8 pb-24 lg:pb-8">
        ...
        <button
          ...
          className="fixed top-4 right-4 lg:top-16 lg:right-8 w-14 h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-[#7C3AED] to-[#EC4899] rounded-full shadow-2xl shadow-[#7C3AED]/30 flex items-center justify-center hover:scale-110 transition-all cursor-pointer group z-40"
        >
      ...
      {showSuccess && (
        <div className="fixed top-4 right-4 lg:top-16 bg-[#7C3AED] text-white px-6 py-3 rounded-lg shadow-lg z-50 flex items-center gap-3">
