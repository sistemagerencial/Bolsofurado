            ...
            <>
              <div className="space-y-4 mb-5">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div>
                    <label className="block text-sm font-medium text-[#9CA3AF] mb-2">
                      Mês <span className="text-[#EC4899]">*</span>
                    </label>
                    <select
                      value={cardExpMonth}
                      onChange={(e) => {
                        setCardExpMonth(e.target.value);
                        setCardErrors({ ...cardErrors, cardExpMonth: '' });
                      }}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#9CA3AF] mb-2">
                      Ano <span className="text-[#EC4899]">*</span>
                    </label>
                    <select
                      value={cardExpYear}
                      onChange={(e) => {
                        setCardExpYear(e.target.value);
                        setCardErrors({ ...cardErrors, cardExpYear: '' });
                      }}
                      className={`w-full px-3 py-3 bg-[#0D0A1A] border rounded-xl text-[#F9FAFB] text-sm focus:outline-none focus:ring-2 transition-all ${
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#9CA3AF] mb-2">
                      CVV <span className="text-[#EC4899]">*</span>
                    </label>
                    <input
                      type="text"
                      value={cardCvv}
              ...
              >
                {isProcessingCard ? (
                  ...
                  <>
                    ...
                    Pagar com Cartão - R$ {selectedPlanData?.price.toFixed(2).replace('.', ',')}
                  </>
                )}
              </button>
            </>
